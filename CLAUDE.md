...
- **Redis (Optional)**
- **Java 25**
- **React** for front-end (under `ui` directory)
- **React Router**

Frontend is built using node and npm via frontend-maven-plugin during the Maven build and packed into the jar file.
Server side rendering is achieved using GraalJS.
